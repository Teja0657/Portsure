...
// import { useState } from "react";
// import "../styles/auth.css";
// import loginIllustration from "../assets/portsure1.jpg"; 

// const DB_KEY = "portsure_users";

// export default function Login({ goToRegister, goToReset, goToDashboard }) {
//   // Roles: "INVESTOR", "COMPLIANCE", "MANAGER"
//   const [role, setRole] = useState("INVESTOR");
//   const [emailOrId, setEmailOrId] = useState("");
//   const [password, setPassword] = useState("");
...
//           <div className="role-switch">
//             <label>
//               <input type="radio" checked={role === "INVESTOR"} onChange={() => setRole("INVESTOR")} />
//               Investor
//             </label>
//             <label>
//               <input type="radio" checked={role === "COMPLIANCE"} onChange={() => setRole("COMPLIANCE")} />
//               Compliance
//             </label>
//             <label>
