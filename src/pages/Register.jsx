...
//   const handleName = (v) => {
//     if (!nameRegex.test(v)) {
//       setErrors((e) => ({ ...e, name: "Name must contain only alphabets" }));
//     } else {
//       setErrors((e) => ({ ...e, name: "" }));
//     }
//     setForm({ ...form, name: v });
...
//     if (!/^\d*$/.test(v)) {
//       setErrors((e) => ({ ...e, mobile: "Enter only numbers" }));
//       return;
//     }
//     // ❌ block more than 10 digits
//     if (v.length > 10) {
//       setErrors((e) => ({ ...e, mobile: "Maximum 10 digits only" }));
//       return; // IMPORTANT: do not update state
//     }
//     // ⚠️ less than 10 digits
//     if (v.length < 10) {
//       setErrors((e) => ({ ...e, mobile: "10 digits required" }));
//     } else {
//       // ✅ exactly 10 digits
...
//       setErrors((e) => ({ ...e, proofId: "Only alphabets and numbers allowed" }));
//     } else {
...
//     if (!form.name || !form.email || !form.password || !form.mobile || !form.proofId) {
...
//     const newUser = {
//       id: role === "INVESTOR" ? `INV-${Date.now()}` : `ADM-${Date.now()}`,
//       role,
//       ...form,
//       portfolios: [],
//     };
...
//             value={form.name} // Added value binding back
...
//             value={form.email} // Added value binding back
...
//             value={form.password} // Added value binding back
//             onChange={(e) => setForm({ ...form, password: e.target.value })}
//           />

//           <ul className="password-rules">
//             <li className={passwordRules.length ? "valid" : "invalid"}>Minimum 8 characters</li>
//             <li className={passwordRules.lowercase ? "valid" : "invalid"}>One lowercase letter</li>
//             <li className={passwordRules.uppercase ? "valid" : "invalid"}>One uppercase letter</li>
//             <li className={passwordRules.number ? "valid" : "invalid"}>One number</li>
//             <li className={passwordRules.special ? "valid" : "invalid"}>One special character</li>
//           </ul>

//           {/* MOBILE */}
//           <input 
//             placeholder="Mobile Number" 
//             value={form.mobile} // Added value binding back
...
//           {/* PROOF */}
//           <input 
//             placeholder="Government Proof ID" 
//             value={form.proofId} // Added value binding back
//             onChange={(e) => handleProof(e.target.value)} 
//           />
...
// import { useState } from "react";
// import "../styles/auth.css";
// import registerIllustration from "../assets/portsure1.jpg";

// const DB_KEY = "portsure_users";
// const STAFF_SECRET_KEY = "PORT-ADMIN-2026"; // The key they must enter

// export default function Register({ goToDashboard, goToLogin }) {
//   const [role, setRole] = useState("INVESTOR");
//   const [form, setForm] = useState({ name: "", email: "", password: "", mobile: "" });
//   const [staffKey, setStaffKey] = useState(""); // State for the secret key
//   const [errors, setErrors] = useState({});
...
//     // --- KEY VALIDATION FOR NON-INVESTORS ---
//     if (role !== "INVESTOR") {
...
//           <img src={registerIllustration} alt="Register Visual" />
//         </div>
...
//                  placeholder="Enter secure key provided by admin" 
